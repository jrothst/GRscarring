...
*by Jean Roth Mon Oct  7 16:42:29 EDT 2002
...
*Remember, household and family data are repeated for each person in cpsmar93.dta
*run with do cpsmar93
*Change input file location 'dictionary using' line on .dct files
*If you are using a PC, you may need to change the direction of the slashes as in C:\
*  or "\\Nber\home\data\cps\cpsmar93\cpsmar93.raw"
