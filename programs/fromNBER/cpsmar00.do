...
*by Jean Roth Wed Oct  9 10:20:36 EDT 2002
...
*Remember, household and family data are repeated for each person in cpsmar00.dta
*run with do cpsmar00
*Change input file location 'dictionary using' line on .dct files
*If you are using a PC, you may need to change the direction of the slashes as in C:\
*  or "\\Nber\home\data\cps\cpsmar00\cpsmar00.raw"
