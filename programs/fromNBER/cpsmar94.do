...
*by Jean Roth Mon Oct  7 16:45:20 EDT 2002
...
*Remember, household and family data are repeated for each person in cpsmar94.dta
*run with do cpsmar94
*Change input file location 'dictionary using' line on .dct files
*If you are using a PC, you may need to change the direction of the slashes as in C:\
*  or "\\Nber\home\data\cps\cpsmar94\cpsmar94.raw"
...
label define h_livqrt
	...
	3           "HU, perm, in trans. hotel, motel"
...
label define hg_pmsa 
	0           "Not a pmsa or not identifiable"
;
...
label define i_mcare 
	0           "No change or children"         
	1           "Allocated"                     
	2           " Not allocated (MCARE set to 1)"
;
label values i_mcaid  i_mcaid;
label define i_mcaid 
	0           "No change or children"         
	1           "Allocated"                     
	2           " Not allocated (MCAID set to 1)"
;
...
label define i_hiyn  
	0           "No change or children"         
	1           "Allocated"                     
	2           " Not allocated COV-HI set to 1"
;
...
label define i_mig1l 
	0           "No change"                     
	1           "GRIN code set to 99998 or 99996"
	2           "Age = 1-14"                    
;
