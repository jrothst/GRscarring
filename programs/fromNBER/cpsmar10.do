...
project, original(${nberdata}/`dofile'.dat.gz)
project, relies_on(${nbercode}/`dofile'.dct)

* Unzip data *

! zcat ${nberdata}/`dofile'.dat.gz > ${nberdata}/`dofile'.dat
...
local dat_name "${nberdata}/`dofile'.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "`prepdata'/`dofile'.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "${nbercode}/`dofile'.dct"
...
note: by Jean Roth, jroth@nber.org Tue May 28 14:32:52 EDT 2013
...
note pxdisear: U PRPERTYP = 2
note m5g_dscp: U M5GSAME = 2
...
label define ch_hi   
	...
	3           "Not covered"                   
;
label values a1rrp    a1rrp;  
label define a1rrp   
	0           "No change"                     
	2           "Blank to value"                
	3           "Value to value"                
;
label values a1age    a1age;  
label define a1age   
	0           "No change"                     
	4           "Allocated"                     
;
label values a1maritl a1maritl;
label define a1maritl
	0           "No change"                     
	4           "Allocated"                     
;
label values a1spouse a1spouse;
label define a1spouse
	0           "No change"                     
	2           "Blank to value"                
	3           "Value to value"                
;
label values a1sex    a1sex;  
label define a1sex   
	0           "No change"                     
	4           "Allocated"                     
;
label values a1hga    a1hga;  
label define a1hga   
	0           "No change"                     
	4           "Allocated"                     
;
...
label define pxafwhna
	...
	53          "Refused to blank"              
;
label values a1whyabs a1whyabs;
label define a1whyabs
	0           "No change or children or armed"
	4           "Allocated"                     
;
label values a1payabs a1payabs;
label define a1payabs
	0           "No change or children or armed"
	4           "Allocated"                     
;
label values a1clswkr a1clswkr;
label define a1clswkr
	0           "No change or children or armed"
	4           "Allocated"                     
;
label values a1nlflj  a1nlflj;
label define a1nlflj 
	0           "No change or children or armed"
	4           "Allocated"                     
;
label values a1uslhrs a1uslhrs;
label define a1uslhrs
	0           "No change or children or armed"
	4           "Allocated"                     
;
label values a1hrlywk a1hrlywk;
label define a1hrlywk
	0           "No change or children or armed"
	4           "Allocated"                     
;
...
label define prhernal
	...
	1           "Allocated"                     
;
label values a1unmem  a1unmem;
label define a1unmem 
	0           "No change or children or armed"
	4           "Allocated"                     
;
label values a1uncov  a1uncov;
label define a1uncov 
	0           "No change or children or armed"
	4           "Allocated"                     
;
label values a1enrlw  a1enrlw;
label define a1enrlw 
	0           "No change or children or armed"
	4           "Allocated"                     
;
label values a1hscol  a1hscol;
label define a1hscol 
	0           "No change or children or armed"
	4           "Allocated"                     
;
label values a1ftpt   a1ftpt; 
label define a1ftpt  
	0           "No change or children or armed"
	4           "Allocated"                     
;
...
label define agi     
	0           "None or not in universe"       
;
label values erp_val  erp_val;
label define erp_val 
	0           "None or not in universe"       
;
label values mwp_val  mwp_val;
label define mwp_val 
	0           "None or not in universe"       
;
...
label define prdisflg
	...
	2           "No"                            
;
label values m5g_cbst m5g_cbst;
label define m5g_cbst
	0           "NIU, nonmover"                 
	1           "CBSA"                          
	2           "non CBSA"                      
	3           "Abroad"                        
	4           "Not identifiable"              
;
label values m5g_dscp m5g_dscp;
label define m5g_dscp
	...
	5           "Not identified"                
;
label values m5gsame  m5gsame;
label define m5gsame 
	0           "NIU"                           
	1           "Yes (nonmover)"                
	2           "No, difference house in U.S."  
	3           "No, outside the U.S. (mover)"  
;
label values m5g_reg  m5g_reg;
label define m5g_reg 
...
label define m5g_st  
	...
	96          "Abroad"                        
;
label values m5g_div  m5g_div;
label define m5g_div 
	0           "Not in universe (under 5 years"
	1           "New England"                   
	2           "Middle Atlantic"               
	3           "East North Central"            
	...
	10          "Aboard"                        
;
label values m5g_mtr1 m5g_mtra;
label define m5g_mtra
	1           "Nonmover"                      
	2           "CBSA to CBSA"                  
	3           "CBSA to nonCBSA"               
	4           "NonCBSA to CBSA"               
	...
	9           "Not identifiable"              
;
label values m5g_mtr3 m5g_mtrc;
label define m5g_mtrc
	1           "Nonmover"                      
	2           "Same county"                   
	3           "Different county, same state"  
	4           "Different state, same division"
...
;
label values m5g_mtr4 m5g_mtrd;
label define m5g_mtrd
	1           "Nonmover"                      
	2           "Same county"                   
	3           "Different county, same state"  
	4           "Different state in Northeast"  
...
;
label values i_m5g1   i_m5g1l;
label define i_m5g1l 
	0           "NIU, or not changed."          
	1           "Assigned from householder."    
	2           "Assigned from spouse"          
	3           "Assign from mother"            
	...
	5           "Allocated from matrix mob"     
;
label values i_m5g2   i_m5g2l;
label define i_m5g2l 
	0           "NIU, or not changed."          
	1           "Assigned from householder"     
	2           "Assigned from spouse"          
	3           "Assigned from mother"          
...
;
label values i_m5g3   i_m5g3l;
label define i_m5g3l 
	0           "NIU, or not changed."          
	1           "State and below assigned"      
	2           "County and below assigned"     
	3           "MCD and below assigned"        
