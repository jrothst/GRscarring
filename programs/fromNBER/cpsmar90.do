...
*by Jean Roth Mon Oct  7 16:26:06 EDT 2002
...
*Remember, household and family data are repeated for each person in cpsmar90.dta
*run with do cpsmar90
*Change input file location 'dictionary using' line on .dct files
*If you are using a PC, you may need to change the direction of the slashes as in C:\
*  or "\\Nber\home\data\cps\cpsmar90\cpsmar90.raw"
