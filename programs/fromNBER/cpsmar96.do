...
*by Jean Roth Mon Oct  7 17:31:19 EDT 2002
...
*Remember, household and family data are repeated for each person in cpsmar96.dta
*run with do cpsmar96
*Change input file location 'dictionary using' line on .dct files
*If you are using a PC, you may need to change the direction of the slashes as in C:\
*  or "\\Nber\home\data\cps\cpsmar96\cpsmar96.raw"
...
label define hg_msac 
	0           "Not MSA/PMSA or not identifiabl"
;
...
label define othstper
	...
	2           "No"                            
;
label values othstyp6 othstypf;
label define othstypf
	0           "NIU"                           
	1           "Medicare"                      
	2           "Medicaid"                      
	3           "CHAMPUS"                       
	...
	9           "Employer/union-provided"       
	10          "Employer/union-provided (as"   
	11          "Privately purchased"           
	12          "Privately purchased (as"       
	13          "Plan of someone outside the"   
	14          "Other"                         
;
...
label define curr    
	...
	2           "No"                            
;
label values curtyp_5 curtyp_e;
label define curtyp_e
	0           "NIU"                           
	1           "Medicare"                      
	2           "Medicaid"                      
	3           "CHAMPUS"                       
	...
	7           "Indian health service"         
	8           "Other government health care"  
	9           "Employer/union-provided (own"  
	10          "Employer/union-provided (as"   
	11          "Privately purchased (own plan)"
	12          "Privately purchased (as"       
	13          "Plan of someone outside the"   
	14          "Other"                         
;
...
label define i_ostyp 
	...
	1           "Allocated"                     
;
label values i_curr   i_curr; 
label define i_curr  
	0           "No"                            
	1           "Allocated"                     
;
label values i_curtyp i_curtyp;
label define i_curtyp
	0           "No"                            
	1           "Allocated"                     
;
