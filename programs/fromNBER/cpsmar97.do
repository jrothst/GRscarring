...
*by Jean Roth Mon Oct  7 17:44:11 EDT 2002
...
*Remember, household and family data are repeated for each person in cpsmar97.dta
*run with do cpsmar97
*Change input file location 'dictionary using' line on .dct files
*If you are using a PC, you may need to change the direction of the slashes as in C:\
*  or "\\Nber\home\data\cps\cpsmar97\cpsmar97.raw"
...
label define prptrea 
	...
	6           "Usually FT - holiday (religious"
