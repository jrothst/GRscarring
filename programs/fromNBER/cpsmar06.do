...
label define statetax_ac
	0           "None"                          
;
label values hurhhscrn hurhhscrn;
label define hurhhscrn
	-3          "Refused"                       
	-2          "Don't know"                    
	-1          "NIU"                           
	1           "Yes"                           
	2           "No"                            
;
label values purkat1  purkat1l;
label define purkat1l
	-3          "Refused"                       
	-2          "Don't know"                    
	-1          "NIU"                           
	1           "Yes"                           
	2           "No"                            
;
label values purkat2  purkat2l;
label define purkat2l
	-3          "Refused"                       
	-2          "Don't know"                    
	-1          "NIU"                           
	1           "At this address"               
	2           "Louisiana (but not at this"    
	3           "Mississippi (but not at"       
	4           "Alabama (but not at this"      
	5           "Florida (but not at this"      
	6           "Elsewhere in the U.S."         
;
label values purkatel purkatel;
label define purkatel
	-1          "NIU"                           
	1           "Person eligible for Katrina"   
