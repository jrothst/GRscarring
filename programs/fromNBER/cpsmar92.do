...
*by Jean Roth Mon Oct  7 16:38:58 EDT 2002
...
*Remember, household and family data are repeated for each person in cpsmar92.dta
*run with do cpsmar92
*Change input file location 'dictionary using' line on .dct files
*If you are using a PC, you may need to change the direction of the slashes as in C:\
*  or "\\Nber\home\data\cps\cpsmar92\cpsmar92.raw"
...
replace     scmst =     scmst[_n-1]  if  hrecord>1
...
label define hhstatus
	...
	3           "Nonfamily householder living with"
;
...
label define a_hga   
	...
	42          "Associate's degree in college -"
	43          "Bachelor's degree (for example:  BA,"
	44          "Master's degree (for example:  MA, MS,"
...
label define hhdfmx  
	...
	48          "Child less than 18, single (never-"
