...
***************************************************************************************************************
if `doasproject'==1 {
	project, original(`raw'/asec2017_pubuse.dat.gz)
	project, relies_on(${nbercode}/`dofile'.dct)
}

* Unzip data *

! zcat `raw'/asec2017_pubuse.dat.gz > ${nberdata}/`dofile'.dat
...
/*------------------------------------------------
  ...
  Adjustments to the code to change from 2016 to 2017 made by Rachel Young 9/12/17
----------------------------------------------- */
