...
*by Jean Roth Mon Oct  7 17:46:43 EDT 2002
...
*Remember, household and family data are repeated for each person in cpsmar98.dta
*run with do cpsmar98
*Change input file location 'dictionary using' line on .dct files
*If you are using a PC, you may need to change the direction of the slashes as in C:\
*  or "\\Nber\home\data\cps\cpsmar98\cpsmar98.raw"
...
label define nxtres  
	0           "NIU (Nonmover or under 1 year old)"
