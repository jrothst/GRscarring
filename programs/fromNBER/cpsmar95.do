...
*by Jean Roth Mon Oct  7 17:05:38 EDT 2002
...
*Remember, household and family data are repeated for each person in cpsmar95.dta
*run with do cpsmar95
*Change input file location 'dictionary using' line on .dct files
*If you are using a PC, you may need to change the direction of the slashes as in C:\
*  or "\\Nber\home\data\cps\cpsmar95\cpsmar95.raw"
...
replace  hrintsta =  hrintsta[_n-1]  if  hrecord>1
replace  hrnumhou =  hrnumhou[_n-1]  if  hrecord>1
...
;
label values hrnumhou hrnumhou;
label define hrnumhou
...
label define hg_msac 
	0           "Not MSA/PMSA or not identifiable"
;
...
label define a_exprrp
	1           "Reference persons with"        
	2           "Reference persons with no"     
	3           "Husband"                       
	4           "Wife"                          
	5           "Natural/adopted child"         
	6           "Step Child (deleted for 1994)" 
	7           "Grandchild"                    
	8           "Parent"                        
	9           "Brother/sister"                
	10          "Other relative"                
	11          "Foster child"                  
	12          "Nonrelative of reference"      
	13          "Partner/roommate"              
	14          "Nonrelative of reference"      
;
...
label define peeduca 
	...
	43          "Bachelor's degree (for example:"
	44          "Master's degree (for example:" 
	45          "Professional school degree"    
	46          "Doctorate degree (for example:"
;
...
label define p_stat  
	1           "Adult civilian household member"
	2           "Adult Armed Forces household"  
	3           "Child"                         
;
...
;
label values pehractt pehractt;
label define pehractt
	0           "Not in universe or children"   
;
...
label define a_whyabs
	...
	7           "Indefinite layoff (30 days or" 
	8           "Other"                         
;
...
label define pelklwo 
	...
	5           "Never worked"                  
;
label values pei01icd pei01icd;
label define pei01icd
	0           "Old not in universe or children"
;
label values pei01ocd pei01ocd;
label define pei01ocd
	0           "Old not in universe or children"
;
...
label define ptrsn   
	0           "Not in universe"               
	1           "Could only find part time job" 
	2           "Wanted part time"              
	3           "Slack work"                    
	4           "Other"                         
;
...
label define dis_sc1l
	...
	4           "U.S. Military Retirement"      
	5           "State or local gov't employee" 
	6           "U.S. Railroad Retirement"      
...
label define peabsrsn
	...
	14          "Other (specify)"               
;
label values pei01cow pei01cow;
label define pei01cow
	0           "NIU"                           
...
label define perrp   
	...
	15          "Housemate/roomate w/rels."     
	16          "Housemate/roomate w/out rels." 
...
;
label values pemovsam pemovsam;
label define pemovsam
	0           "NIU (Under 1 year old)"        
	1           "Non Mover"                     
	2           "Mover:  Different house in U.S."
	3           "Mover:  Outside the U.S."      
;
label values pemovliv pemovliv;
label define pemovliv
	0           "NIU (Under 1 year old)"        
	1           "Same county"                   
	...
	4           " Outside the U.S."             
;
label values pemovsta pemovsta;
label define pemovsta
	0           "NIU"                           
	1           "Alabama"                       
	2           "Alaska"                        
	4           "Arizona"                       
	...
	56          "Wyoming"                       
;
label values i_movsam i_movsam;
label define i_movsam
	0           "NIU, or not changed"           
	1           "Assigned"                      
	2           "Allocated"                     
;
label values i_movliv i_movliv;
label define i_movliv
	0           "NIU, or not changed"           
	1           "Assigned"                      
	2           "Allocated"                     
;
label values i_movsta i_movsta;
label define i_movsta
	0           "NIU, or not changed"           
	1           "Assigned"                      
	2           "Allocated"                     
;
