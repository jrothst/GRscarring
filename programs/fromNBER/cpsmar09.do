...
replace  hufaminc =  hufaminc[_n-1]  if  hrecord>1
...
note: by Jean Roth, jroth@nber.org Fri Jan 20 14:04:36 EST 2012
note h_seq: U All households
note hufaminc: U H-HHTYPE = 1
...
label define gtcbsa  
	...
	3720        "Kalamazoo-Battle Creek, MI MSA* (Van Buren County not in"
	6450        "Portsmouth-Rochester, NH-ME MSA* (ME portion not identified)"
	10420       "Akron, OH"                     
...
label define pxafwhna
	...
	23          "Refused to longitudinal value" 
	30          "Value to allocated value long" 
	31          "Blalnk to allocated value long"
	32          "Don't know to allocated value" 
	33          "Refused to allocated value long"
	40          "Value to allocated value"      
	41          "Blank to allocated value"      
...
label define othstypa
	...
	15          "Other"                         
;
label values stimulus stimulus;
label define stimulus
	0           "None"                          
;
...
label define pxdisear
	...
	53          "Refused to blank"              
;
label values pxdiseye pxdiseye;
label define pxdiseye
	-1          "Not allocated"                 
	0           "Value - no change"             
	1           "Blank - no change"             
	2           "Don't know - no change"        
	...
	53          "Refused to blank"              
;
label values pxdisrem pxdisrem;
label define pxdisrem
	-1          "Not allocated"                 
	0           "Value - no change"             
	1           "Blank - no change"             
	2           "Don't know - no change"        
	...
	53          "Refused to blank"              
;
label values pxdisphy pxdisphy;
label define pxdisphy
	-1          "Not allocated"                 
	0           "Value - no change"             
	1           "Blank - no change"             
	2           "Don't know - no change"        
	...
	53          "Refused to blank"              
;
label values pxdisdrs pxdisdrs;
label define pxdisdrs
	-1          "Not allocated"                 
	0           "Value - no change"             
	1           "Blank - no change"             
	2           "Don't know - no change"        
	...
	53          "Refused to blank"              
;
label values pxdisout pxdisout;
label define pxdisout
	-1          "Not allocated"                 
	0           "Value - no change"             
	1           "Blank - no change"             
	2           "Don't know - no change"        
