...
local raw "~/data/cps/march/rawdata"
...
***************************************************************************************************************
if `doasproject'==1 {
	project, original(`raw'/asec2018_pubuse.dat.gz)
	project, relies_on(${nbercode}/`dofile'.dct)
}

* Unzip data *

! zcat `raw'/asec2018_pubuse.dat.gz > ${nberdata}/`dofile'.dat
...
/*------------------------------------------------
  ...
  Run with do cpsmar2018
  Adjustments to the code to change from 2017 to 2018 made by Nathaniel Ruby 9/18/18
----------------------------------------------- */
...
local dta_name "${nberdata}/`dofile'.dta"
