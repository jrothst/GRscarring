   ...
   foreach e in 0 1 {
    ...
    // Models:
     ...
     //   Ab: Just cohort, age, and state effects, including most recent data
      ...
      eststo mod_`v'_mA`e'`s'b, noesample title(`v'_mA`e'`s'b)
     ...
     //   Bb: Age-time-cohort and state FEs, including most recent data
      ...
      eststo mod_`v'_mB`e'`s'b, noesample title(`v'_mB`e'`s'b)
     ...
     //   Cb: A-T-C + UR(t)*Agroups (excluding one), including most recent data
      ...
      eststo mod_`v'_mC`e'`s'b, noesample title(`v'_mC`e'`s'b)
     ...
     //   Db: A-T-C + UR(0)*Agroups, including most recent data
      ...
      eststo mod_`v'_mD`e'`s'b, noesample title(`v'_mD`e'`s'b)
     ...
     //   Eb: A-T-C + UR(t)*Agroups + UR(0)*Agroups, including most recent data
      ...
      eststo mod_`v'_mE`e'`s'b, noesample title(`v'_mE`e'`s'b)
     ...
     //   Ac: Just entrycohort, age, and state effects, including most recent data
      ...
      eststo mod_`v'_mA`e'`s'c, noesample title(`v'_mA`e'`s'c)
     ...
     //   Bc: Age-time-entrycohort and state FEs, including most recent data
      ...
      eststo mod_`v'_mB`e'`s'c, noesample title(`v'_mB`e'`s'c)
     ...
     //   Cc: A-T-C + UR(t)*Agroups (excluding one), including most recent data
      ...
      eststo mod_`v'_mC`e'`s'c, noesample title(`v'_mC`e'`s'c)
     ...
     //   Dc: A-T-C + UR(0)*Agroups, including most recent data
      ...
      eststo mod_`v'_mD`e'`s'c, noesample title(`v'_mD`e'`s'c)
     ...
     //   Ec: A-T-C + UR(t)*Agroups + UR(0)*Agroups, including most recent data
      ...
      eststo mod_`v'_mE`e'`s'c, noesample title(`v'_mE`e'`s'c)
 ...
 save `prepdata'/`dofile'_fitted.dta, replace
  ...
  // data sets.    
   ...
   foreach v in `dvlist' {
     foreach e in 0 1 {
       foreach s in 0 1 {
       use `mA`e'`s'b_`v'', clear
       append using                 `mB`e'`s'b_`v'' `mC`e'`s'b_`v'' `mD`e'`s'b_`v'' `mE`e'`s'b_`v'' ///
